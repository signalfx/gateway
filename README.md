...
`github.com/signalfx/gohelpers`                              | [Apache Software License v2.0](./vendor/github.com/signalfx/gohelpers/LICENSE)
...
`github.com/uber/tchannel-go`                                | [MIT](./vendor/github.com/uber/tchannel-go/LICENSE.md)
...
`golang.org/x/lint`                                          | [BSD 3-Clause](./vendor/github.com/golang/lint/LICENSE)
...
`golang.org/x/tools`                                         | [BSD 3-Clause](./vendor/github.com/golang/tools/LICENSE)
`google.golang.org/googleapis`                               | [Apache Software License v2.0](./vendor/github.com/google/go-googleapis/LICENSE)
...
`gopkg.in/logfmt.v0`                                         | [MIT](./vendor/gopkg.in/logfmt.v0/LICENSE)
`gopkg.in/natefinch/lumberjack.v2`                           | [MIT](./vendor/gopkg.in/natefinch/lumberjack/LICENSE)
`gopkg.in/stack.v1`                                          | [MIT](./vendor/gopkg.in/stack.v1/LICENSE.md)
`gopkg.in/yaml.v2`                                           | [Apache Software License v2.0](./vendor/gopkg.in/yaml.v2/LICENSE)
`gotest.tools`                                               | [Apache Software License v2.0](./vendor/gotest.tools/LICENSE)
